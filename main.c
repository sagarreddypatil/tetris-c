...
// undefined, cyan, blue, orange, yellow, green, purple, red
const Color COLORS[8] = {{0x00, 0x00, 0x00}, {0x00, 0xff, 0xff}, {0x00, 0x00, 0xff}, {0xff, 0x7f, 0x00},
                         {0xff, 0xff, 0x00}, {0x00, 0xff, 0x00}, {0xa2, 0x28, 0xff}, {0xff, 0x00, 0x00}};
...
void drawBox(SDL_Renderer *renderer, int posX, int posY, int color)
{
